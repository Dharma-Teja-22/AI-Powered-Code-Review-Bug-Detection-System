...
export default function ReviewSection({ result, isLoading }) {
      ...
      {isLoading ? (
        ...
        <Accordion type="multiple" collapsible className="w-full">
          <AccordionItem value="review">
            ...
            <AccordionContent>
              <Markdown className="text-[15px]" rehypePlugins={rehypeRaw}>
                {review ? review : "This is a sample code review."}
              </Markdown>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="bugs">
            ...
            <AccordionContent>
              <Markdown className="text-[15px]" rehypePlugins={rehypeRaw}>
                {bugs
                  ? bugs
                  : "These are some potential bugs found in the code."}
              </Markdown>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="visualization">
            ...
            <AccordionContent>
              {result?.response ? (
                <Vizualization result={result} />
              ) : (
                <p className="text-[15px]">
                  {" "}
                  Submit your code to get the response
                </p>
              )}
            </AccordionContent>
          </AccordionItem>
